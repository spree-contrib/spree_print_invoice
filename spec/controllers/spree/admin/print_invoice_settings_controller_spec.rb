  ...
  context '#update' do
    ...
    context 'For parameters:
      ...
      it 'sets preferred_next_number to 1' do
        spree_put :update, preferences: { next_number: 1 }
